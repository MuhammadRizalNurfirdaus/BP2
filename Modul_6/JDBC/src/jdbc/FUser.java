...
import javax.swing.ImageIcon; // Ditambahkan untuk ImageIcon
...
public class FUser extends javax.swing.JFrame {
    ...
    private int getIdLevelByName(String levelName) {
        ...
        if (levelName.equalsIgnoreCase("ADMIN")) return 1;
        if (levelName.equalsIgnoreCase("GUDANG")) return 2;
        if (levelName.equalsIgnoreCase("KASIR")) return 3;
        return 0;
    }
    ...
    private void initComponents() {
        ...
        // --- TUGAS NOMOR 2: Lengkapi Button dengan Icon ---
        // Pastikan Anda memiliki file ikon di path yang benar (misal: src/icons/save_icon.png)
        // Jika ikon tidak ditemukan, tidak akan ada error, tapi ikon tidak tampil.
        try {
            ...
            // Anda bisa menambahkan pesan ini jika ingin tahu jika ikon tidak termuat.
            // Atau biarkan saja, tombol akan tampil tanpa ikon.
        }
        // --- Akhir Tugas Nomor 2 ---
    ...
    private void BSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BSimpanActionPerformed
        ...
        // --- TUGAS NOMOR 1: Event Handler untuk Form Kosong ---
        if (namaUser.isEmpty() || jk.isEmpty() || nope.isEmpty() || username.isEmpty() || password.isEmpty() || CLevel.getSelectedIndex() == -1 /* Bisa juga cek levelName jika punya nilai default seperti "- Pilih Level -" */) {
            JOptionPane.showMessageDialog(this, "Data Harus Diisi !!", "Peringatan", JOptionPane.WARNING_MESSAGE); // Pesan sesuai permintaan
            return; // Hentikan proses jika ada data yang kosong
        }
        // --- Akhir Tugas Nomor 1 ---


        // --- POST TEST 1 (dari soal sebelumnya): YesNoQuestion Penyimpanan Data ---
        ...
        if (konfirmasi == JOptionPane.YES_OPTION) {
            ...
            try {
                ...
                if (rowsInserted > 0) {
                    JOptionPane.showMessageDialog(this, "Data Barang Berhasil Dimasukan");

                    load_data(); // POST TEST 3 (dari soal sebelumnya)
                    bersih();    // POST TEST 2 (dari soal sebelumnya)
                }
            } catch (SQLException e) {
    ...
    private void BEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BEditActionPerformed
        ...
        JOptionPane.showMessageDialog(this, "Fungsi Edit belum diimplementasikan.");
    }//GEN-LAST:event_BEditActionPerformed

    private void BHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BHapusActionPerformed
        // TODO: Implementasi fungsi Hapus
        JOptionPane.showMessageDialog(this, "Fungsi Hapus belum diimplementasikan.");
